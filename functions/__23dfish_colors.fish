function __23dfish_colors -S -a color_scheme -d 'Define colors used by 23dfish'
  switch "$color_scheme"
    case 'user'
      __23dfish_user_color_scheme_deprecated
      return
  ...
  case '23d' # default 23d theme
      #               light  medium dark
      #               ------ ------ ------
      set -l red      cc3333 ce000f 660000
      set -l green    addc10 189303 0c4801
      set -l blue     48b4fb 005faf 255e87
      set -l orange   f6b117 unused 3a2a03
      set -l brown    bf5e00 803f00 4d2600
      ...
      set -x color_repo_dirty               $red[1] $red[1]
      set -x color_repo_staged              $orange[3] $orange[1]
    ...
    case '*' # default dark theme
        ...
        set -x color_path_basename            $grey[3] $white
        set -x color_path_nowrite             $red[3] $red[1]
        set -x color_path_nowrite_basename    $red[3] $red[1] --bold
...
function __23dfish_user_color_scheme_deprecated
  ...
  echo "To define a custom color scheme, create a '23dfish_colors' function:"
  set_color normal
  echo

  echo "function 23dfish_colors -S -d 'Define a custom 23dfish color scheme'

  # optionally include a base color scheme...
  ___23dfish_colors default
