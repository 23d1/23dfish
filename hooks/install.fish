...
if [ "$installed_version" != "$latest_version" ]
  ...
  echo "Fish $required_version or greater is required for 23dfish."
  echo
  echo "To use 23dfish with Fish $installed_version, checkout the `support/fish-2.2.x` branch"
  echo "in $OMF_PATH/themes/23dfish/"
